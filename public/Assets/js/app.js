...
var MyApp = (function () {
  ...
  $(document).on("click", ".end-call-wrap", function () {
    $(".top-box-show")
      ...
      .html(
        '<div class="top-box align-vertical-middle profile-dialogue-show"> <h4 style="margin-top:4rem;text-align:center;color:white;">Leave Meeting</h4> <hr> <div class="call-leave-cancel-action d-flex justify-content-center align-items-center w-100"> <a href="/action.html"><button class="call-leave-action btn btn-danger mr-5">Leave</button></a> <button class="call-cancel-action btn btn-secondary">Cancel</button> </div> </div>'
      );
  });
